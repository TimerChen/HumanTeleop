...
def calibration(servo_ids, flip):
...
if not os.path.exists(calib_file):
    zero_positions, flip_directions = calibration(servo_ids, flip_directions)
...
with ServoController(servo_ids, "sts") as controller:
    while True:
        if ECHO:
