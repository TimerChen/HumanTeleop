...
if __name__ == '__main__':
    ...
    parser.add_argument('--ctrl-mode', type=str, default=CTL_MODE, help='Control mode (mit or custom_so101)', choices=['mit', 'spd'])
    parser.add_argument('--msg-mode', type=str, default=MSG_MODE, help='Message mode (gello or custom_so101)', choices=['gello', 'custom_so101'])
    ...
    try:
        while True:
            ...
            if MSG_MODE == 'gello':
                ...
                data = np.array(data, dtype=np.uint16).astype(np.int32)
